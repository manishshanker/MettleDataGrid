(function ($) {
    ...
    $.mettleDataGrid.filter.DATE = {
        ...
        init: function ($filter, onFilter, gridId, $mettleDataGrid) {
            ...
            $mettleDataGrid.find(".mettleDataGrid-rows").bind("scroll.datefilter-" + $filter.attr("id"), function () {
        ...
        destroy: function ($filter, $mettleDataGrid) {
            $mettleDataGrid.find(".mettleDataGrid-rows").unbind("scroll.datefilter-" + $filter.attr("id"));

(function (mettleDataGridFakeSource) {
    ...
    mettleDataGridFakeSource.fakeDataSet1 = (function () {
        function getColumns() {
            return [
                {
                    label: "Status",
            ...
            return [
                {
                    id: "colStatus",
                    type: "MULTI_SELECT",
                    value: mettleDataGridFakeSource.getFilterData("colStatus", rows)
                },
                {
                    id: "colCCP",
                    type: "MULTI_SELECT",
                    value: mettleDataGridFakeSource.getFilterData("colCCP", rows)
                },
                {
                    id: "colTradeId",
                    type: "FREE_TEXT",
                ...
                },
                {
                    id: "colCurrency",
                    type: "MULTI_SELECT",
                    value: mettleDataGridFakeSource.getFilterData("colCurrency", rows)
                },
                {
                    id: "colBuySell",
                    type: "MULTI_SELECT",
                    value: mettleDataGridFakeSource.getFilterData("colBuySell", rows)
                }
            ];
        }
